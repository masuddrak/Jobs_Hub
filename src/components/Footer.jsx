...
const Footer = () => {
	...
	const myCurrentPath=locatin.pathname
	console.log(myCurrentPath)
    return (
<footer className={`px-4  bg-neutral text-white shadow-lg ${myCurrentPath == "/statistics" || myCurrentPath=="/applied"?"absolute w-full bottom-0":""}` }>
